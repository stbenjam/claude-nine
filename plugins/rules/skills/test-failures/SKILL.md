...
3. **Check if your changes touch the failing execution path** — follow imports, shared state, interfaces, and transitive dependencies. Subtle interactions count.
...
- Offer to fix it (Boy Scout Rule: leave the repository better than you found it).
