...
description: Load and query a Goodreads CSV export as the Goodreads backend for the books-book-library skill.
user-invocable: false
---

# Goodreads backend

Use the bundled `scripts/goodreads_lib.py` helper; do not write a second CSV
...
the directory containing this skill's `scripts/` folder to `sys.path` rather
