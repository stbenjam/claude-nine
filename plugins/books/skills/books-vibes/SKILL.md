...
[`../books-library/SKILL.md`](../books-library/SKILL.md) to choose the authoritative backend, then read
[`../books-library/references/similarity.md`](../books-library/references/similarity.md).
