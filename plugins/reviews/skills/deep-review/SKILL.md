...
<details>
<summary><h3>Specialist Findings</h3></summary>

<details>
<summary><b>Bugs</b> (N findings: X blocking, Y suggestions)</summary>
...
<details>
<summary><b>Adversarial</b> (N findings: X blocking, Y suggestions, Z notes)</summary>

<table of findings, with "Prove it wrong or admit you can't" results>

</details>

<details>
<summary><b>Security & Supply Chain</b> (N findings: ...)</summary>
...
<details>
<summary><b>Architecture</b> (N findings: ...)</summary>
...
<details>
<summary><b>Codebase Consistency</b> (N findings: ...)</summary>
...
<details>
<summary><b>QA Engineer</b> (N findings: ...)</summary>
...
<details>
<summary><b>Technical Writer</b> (N findings: ...)</summary>
...
<sub>Generated by [/deep-review](https://github.com/stbenjam/claude-nine/tree/main/plugins/reviews/skills/deep-review)</sub>
```

Omit the "External Reviewers" section when none were requested.

The "Specialist Findings" section uses nested `<details>` blocks so
findings are collapsed by default — readers can expand individual
specialists they care about without scrolling past the full list.
Each specialist's `<summary>` line includes a count of findings by
severity (e.g., "3 findings: 1 blocking, 2 suggestions").
